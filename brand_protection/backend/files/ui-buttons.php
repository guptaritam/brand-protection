                    ...
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="button-list">
                                    ...
                                    <button type="button" class="btn btn-purple waves-effect waves-light">Purple
                                    </button>
                                    ...
                                    <button type="button" class="btn btn-custom waves-effect waves-light">Custom
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="button-list">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-rounded waves-effect">Secondary
                                    </button>
                                    ...
                                    <button type="button" class="btn btn-purple btn-rounded waves-effect waves-light">
                                        Purple
                                    </button>
                        ...
                        <div class="row m-t-50">
                            <div class="col-md-6 m-t-20">
                                ...
                                <div class="button-list">
                                    <button type="button" class="btn btn-primary-outline waves-effect waves-light">
                                        Primary
                                    </button>
                                    <button type="button" class="btn btn-secondary-outline waves-effect">Secondary
                                    </button>
                                    <button type="button" class="btn btn-success-outline waves-effect waves-light">
                                        Success
                                    </button>
                                    <button type="button" class="btn btn-info-outline waves-effect waves-light">Info
                                    </button>
                                    <button type="button" class="btn btn-warning-outline waves-effect waves-light">
                                        Warning
                                    </button>
                                    <button type="button" class="btn btn-danger-outline waves-effect waves-light">
                                        Danger
                                    </button>
                                    <button type="button" class="btn btn-dark-outline waves-effect waves-light">Dark
                                    </button>
                                    <button type="button" class="btn btn-purple-outline waves-effect waves-light">
                                        Purple
                                    </button>
                                    <button type="button" class="btn btn-pink-outline waves-effect waves-light">Pink
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 m-t-20">
                                ...
                                <p class="text-muted m-b-20 font-13">
                                    In need of a button, but not the hefty background colors they bring? Replace the
                                    default modifier classes with the <code>.btn-*-outline</code>
                                    <code>.btn-rounded</code> ones to remove all background images and colors on any
                                    button.
                                </p>

                                <div class="button-list">
                                    <button type="button"
                                            class="btn btn-primary-outline btn-rounded waves-effect waves-light">Primary
                                    </button>
                                    <button type="button" class="btn btn-secondary-outline btn-rounded waves-effect">
                                        Secondary
                                    </button>
                                    <button type="button"
                                            class="btn btn-success-outline btn-rounded waves-effect waves-light">Success
                                    </button>
                                    <button type="button"
                                            class="btn btn-info-outline btn-rounded waves-effect waves-light">Info
                                    </button>
                                    <button type="button"
                                            class="btn btn-warning-outline btn-rounded waves-effect waves-light">Warning
                                    </button>
                                    <button type="button"
                                            class="btn btn-danger-outline btn-rounded waves-effect waves-light">Danger
                                    </button>
                                    <button type="button"
                                            class="btn btn-dark-outline btn-rounded waves-effect waves-light">Dark
                                    </button>
                                    <button type="button"
                                            class="btn btn-purple-outline btn-rounded waves-effect waves-light">Purple
                                    </button>
                                    <button type="button"
                                            class="btn btn-pink-outline btn-rounded waves-effect waves-light">Pink
                                    </button>
                                </div>
                        ...
                        <div class="row m-t-50">
                            <div class="col-md-6 m-t-20">
                                ...
                                <p class="text-muted m-b-30 font-13">
                                    Create buttons with minimum width by adding add <code>.w-xs</code>,
                                    <code>.w-sm</code>, <code>.w-md</code> or <code>.w-lg</code>.
                                </p>

                                <div class="button-list">
                                    <button type="button" class="btn btn-primary waves-effect waves-light w-xs">Xs
                                    </button>
                                    <button type="button" class="btn btn-purple waves-effect waves-light w-sm">Small
                                    </button>
                                    <button type="button" class="btn btn-info waves-effect waves-light w-md">Middle
                                    </button>
                                    <button type="button" class="btn btn-warning waves-effect waves-light w-lg">Large
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 m-t-20">
                                ...
                                <div class="button-list">
                                    <button class="btn btn-primary waves-effect waves-light btn-lg">Large button
                                    </button>
                                    <button class="btn btn-success waves-effect waves-light btn-sm">Small button
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="row m-t-50">
                            <div class="col-md-6 m-t-20">
                                ...
                                <p class="text-muted m-b-20 font-13">
                                    ...
                                    with class <code>.btn-label</code> and any <code>icon</code> inside it. If you want
                                    to put
                        ...
                        <div class="row m-t-50">
                            <div class="col-md-6 m-t-20">
                                ...
                                <div class="button-list">
                                    <button class="btn waves-effect btn-secondary"><i class="fa fa-heart-o"></i>
                                    </button>
                                    <button class="btn waves-effect waves-light btn-danger disabled"><i
                                            class="fa fa-remove"></i></button>
                                    <button class="btn waves-effect waves-light btn-purple"><i class="fa fa-music"></i>
                                    </button>
                                    <button class="btn waves-effect waves-light btn-primary"><i class="fa fa-star"></i>
                                    </button>
                                    <button class="btn waves-effect waves-light btn-success"><i
                                            class="fa fa-thumbs-o-up"></i></button>
                                    <button class="btn waves-effect waves-light btn-info"><i
                                            class="fa fa-keyboard-o"></i></button>
                                    <button class="btn waves-effect waves-light btn-warning"><i
                                            class="fa fa-wrench"></i></button>
                                    <br>
                                    <button class="btn btn-secondary waves-effect"><i class="fa fa-heart m-r-5"></i>
                                        <span>Like</span></button>
                                    <button class="btn btn-dark waves-effect waves-light"><i
                                            class="fa fa-envelope-o m-r-5"></i> <span>Share</span></button>
                                    <button class="btn btn-warning waves-effect waves-light"><i
                                            class="fa fa-rocket m-r-5"></i> <span>Launch</span></button>
                                    <button class="btn btn-info waves-effect waves-light disabled"><i
                                            class="fa fa-cloud m-r-5"></i> <span>Cloud Hosting</span></button>
                                    <button class="btn btn-pink waves-effect waves-light"><span>Book Flight</span> <i
                                            class="fa fa-plane m-l-5"></i></button>
                                    <button class="btn btn-purple waves-effect waves-light"><span>Donate Money</span> <i
                                            class="fa fa-money m-l-5"></i></button>
                                </div>
                            ...
                            <div class="col-md-6 m-t-20">
                                ...
                                <div class="button-list">
                                    <button type="button"
                                            class="btn btn-block btn-lg btn-primary waves-effect waves-light">Block
                                        Button
                                    </button>
                                    <button type="button"
                                            class="btn btn-block btn--md btn-pink waves-effect waves-light active">Block
                                        Button
                                    </button>
                                    <button type="button"
                                            class="btn btn-block btn-sm btn-success waves-effect waves-light">Block
                                        Button
                                    </button>
                                </div>
                        ...
                        <div class="row m-t-50">
                            <div class="col-md-6 m-t-20">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="btn-group-vertical m-b-20">
                                            <button type="button" class="btn btn-secondary waves-effect">Button 1
                                            </button>
                                            <button type="button" class="btn btn-secondary waves-effect">Button 2
                                            </button>
                                            <button type="button" class="btn btn-secondary dropdown-toggle waves-effect"
