                                    ...
                                    <div class="text-xs-center">
                                        <ul class="list-inline chart-detail-list">
                                            <li class="list-inline-item">
                                                <h6 style="color: #1bb99a;"><i class="zmdi zmdi-circle-o m-r-5"></i>Series
                                                    A</h6>
                                            </li>
                                            <li class="list-inline-item">
                                                <h6 style="color: #f1b53d;"><i class="zmdi zmdi-triangle-up m-r-5"></i>Series
                                                    B</h6>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-sm-12 col-xs-12 col-md-6">
                                ...
                                <div class="p-20 p-b-0">
                                    <div class="text-xs-center">
                                        <ul class="list-inline chart-detail-list">
                                            <li class="list-inline-item">
                                                <h6 style="color: #3db9dc;"><i class="zmdi zmdi-circle-o m-r-5"></i>Series
                                                    A</h6>
                                            </li>
                                            <li class="list-inline-item">
                                                <h6 style="color: #f1b53d;"><i class="zmdi zmdi-triangle-up m-r-5"></i>Series
                                            ...
                                            <li class="list-inline-item">
                                                <h6 style="color: #ff5d48;"><i class="zmdi zmdi-square-o m-r-5"></i>Series
                                                    C</h6>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="p-20">
                                    <div class="text-xs-center">
                                        <ul class="list-inline chart-detail-list">
                                            ...
                                            <li class="list-inline-item">
                                                <h6 style="color: #039cfd;"><i class="zmdi zmdi-triangle-up m-r-5"></i>Series
                                                    B</h6>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-sm-12 col-xs-12 col-md-6 m-t-20">
                                ...
                                <div class="p-20">
                                    <div class="text-xs-center">
                                        <ul class="list-inline chart-detail-list">
                                            <li class="list-inline-item">
                                                <h6 style="color: #9261c6;"><i class="zmdi zmdi-circle-o m-r-5"></i>Series
                                                    A</h6>
                                            </li>
                                            <li class="list-inline-item">
                                                <h6 style="color: #ff7aa3;"><i class="zmdi zmdi-triangle-up m-r-5"></i>Series
                                                    B</h6>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-sm-12 col-xs-12 col-md-6 m-t-20">
                                ...
                                <div class="p-20">
                                    ...
                                    <div class="text-xs-center">
                                        <ul class="list-inline chart-detail-list">
                                            <li class="list-inline-item">
                                                <h6 style="color: #f1b53d;"><i class="zmdi zmdi-circle-o m-r-5"></i>Series
                                                    A</h6>
                                            </li>
                                            <li class="list-inline-item">
                                                <h6 style="color: #9261c6;"><i class="zmdi zmdi-triangle-up m-r-5"></i>Series
                                                    B</h6>
                                            </li>
                                            <li class="list-inline-item">
                                                <h6 style="color: #ff7aa3;"><i class="zmdi zmdi-square-o m-r-5"></i>Series
                                                    C</h6>
                                            </li>
                                        </ul>
                                    </div>
