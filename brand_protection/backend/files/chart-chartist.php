                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12 col-md-6">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        ...
                                        in some cases you'd like to animate SVG properties that are not available in
                                        CSS.
                                    </p>
                                ...
                                <div class="col-sm-12 col-xs-12 col-md-6">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        An example of a simple line chart with three series. You can edit this example
                                        in realtime.
                                    </p>
                            ...
                            <div class="row m-t-50">
                                ...
                                <div class="col-sm-6 col-xs-12 m-t-20">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        ...
                                        There's no new chart type you need to learn, just passing an additional option
                                        is enough.
                                    </p>
                                ...
                                <div class="col-sm-6 col-xs-12 m-t-20">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        ...
                                        override mechanism of Chartist, you can create a chart that adopts to every
                                        media condition!
                                    </p>
                            ...
                            <div class="row m-t-50">
                                ...
                                <div class="col-sm-6 col-xs-12 m-t-20">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        ...
                                        make sure that you pass a single series array to Chartist that contains the
                                        series values.
                                    </p>
