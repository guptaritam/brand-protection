            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="assets/images/gallery/6.jpg" alt="Card image cap">
                    </div>
                </div>

                <div class="col-sm-4 col-xs-12">
                    <div class="card card-inverse">
                        <img class="card-img img-fluid" src="assets/images/gallery/7.jpg" alt="Card image">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="card-deck-wrapper">
                        <div class="card-deck">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="assets/images/gallery/1.jpg"
                                     alt="Card image cap">
                                <div class="card-block">
                                    <h4 class="card-title">Card title</h4>
                            ...
                            <div class="card">
                                <img class="card-img-top img-fluid" src="assets/images/gallery/12.jpg"
                                     alt="Card image cap">
                                <div class="card-block">
                                    <h4 class="card-title">Card title</h4>
