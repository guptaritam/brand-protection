                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                ...
                                <p class="text-muted m-b-20 font-13">
                                    Roll your own navigation style by extending the base .nav component. All Bootstrap’s
                                    nav components are built on top of this by specifying additional styles.
                                </p>
                            ...
                            <div class="col-md-6 col-xs-12 m-t-sm-40">
                                ...
                                <p class="text-muted m-b-20 font-13">
                                    Easily space out nav links in a horizontal band with <code>.nav-inline</code>.
                            ...
                            <div class="col-md-6 col-xs-12 m-t-sm-40 m-t-20">
                                ...
                                <ul class="nav nav-pills m-b-10" id="myTabalt" role="tablist">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" id="dropdown1-tab1" href="#dropdown1-alt"
                                               role="tab"
                                               data-toggle="tab" aria-controls="dropdown1">@fat</a>
                                            <a class="dropdown-item" id="dropdown2-tab1" href="#dropdown2-alt"
                                               role="tab"
                                               data-toggle="tab" aria-controls="dropdown2">@mdo</a>
                                        </div>
                                    </li>
