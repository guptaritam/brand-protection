                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    <ul class="list-unstyled chart-detail-list m-t-30">
                                        ...
                                        <li class="m-b-10">
                                            <h6 style="color: #1bb99a;"><i class="zmdi zmdi-circle-o m-r-5"></i>Series B
                                            </h6>
                                        </li>
                                        <li class="m-b-10">
                                            <h6 style="color: #f1b53d;"><i class="zmdi zmdi-circle-o m-r-5"></i>Series C
                                            </h6>
                                        </li>
                                        <li class="m-b-10">
                                            <h6 style="color: #ff7aa3;"><i class="zmdi zmdi-circle-o m-r-5"></i>Series D
                                            </h6>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    <ul class="list-unstyled chart-detail-list m-t-30">
                                        <li class="m-b-10">
                                            <h6 style="color: #3db9dc;"><i class="zmdi zmdi-circle-o m-r-5"></i>Desktops
                                            </h6>
                                        </li>
                                        <li class="m-b-10">
                                            <h6 style="color: #1bb99a;"><i class="zmdi zmdi-circle-o m-r-5"></i>Tablets
                                            </h6>
                                        </li>
                                        <li class="m-b-10">
                                            <h6 style="color: #f1b53d;"><i class="zmdi zmdi-circle-o m-r-5"></i>Mobiles
                                            </h6>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="card-box">
                            ...
                            <div class="widget-chart text-xs-center">
                                <input data-plugin="knob" data-width="150" data-height="150" data-linecap=round
                                       data-fgColor="#5d9cec" value="55" data-skin="tron" data-angleOffset="180"
                                       data-readOnly=true data-thickness=".15"/>

                                <p class="text-muted font-13 m-t-30">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    elit. Integer nec odio. Praesent libero. Nunc nec dui vitae urna cursus lacinia. In
                    ...
                    <div class="col-lg-4">
                        <div class="card-box">
                            ...
                            <div class="widget-chart text-xs-center">
                                <input data-plugin="knob" data-width="150" data-height="150" data-linecap=round
                                       data-fgColor="#34d3eb" value="60" data-skin="tron" data-angleOffset="180"
                                       data-readOnly=true data-thickness=".15"/>
