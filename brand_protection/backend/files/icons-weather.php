                        ...
                        <div class="">
                            ...
                            <div class="card-box">
                                ...
                                <div class="alert alert-success">
                                    ...
                                    There is a primary
                                    set and alternate set. The primary set is meant to be interpreted as: where there
                                    are pixels, that is the
                                    illuminated part of the moon. The alternate set is meant to be interpreted as: where
                                    there are pixels,
                                ...
                                <div class="alert alert-success">
                                    Use these special, built-in utility classes to flip, rotate, or assign a fixed width
                                    to any icon.
                                </div>
                                <div class="row">
