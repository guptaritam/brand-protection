                        ...
                        <div class="row m-t-50">
                            <div class="col-sm-12 col-xs-12 col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-3 col-md-2">
                                        <div class="p-20 text-xs-center">
                                            <span data-plugin="peity-donut" data-colors="#3db9dc,#ebeff2"
                                                  data-width="80" data-height="80">1/5</span>
                                        </div>
                                    </div>

                                    <div class="col-xs-6 col-sm-3 col-md-2">
                                        <div class="p-20 text-xs-center">
                                            <span data-plugin="peity-donut" data-colors="#ff7aa3,#ebeff2"
                                                  data-width="80" data-height="80">226/360</span>
                                        </div>
                                    </div>

                                    <div class="col-xs-6 col-sm-3 col-md-2">
                                        <div class="p-20 text-xs-center">
                                            <span data-plugin="peity-donut" data-colors="#039cfd,#ebeff2"
                                                  data-width="80" data-height="80">0.52/1.561</span>
                                        </div>
                                    </div>

                                    <div class="col-xs-6 col-sm-3 col-md-2">
                                        <div class="p-20 text-xs-center">
                                            <span data-plugin="peity-donut" data-colors="#1bb99a,#ebeff2"
                                                  data-width="80" data-height="80">1/4</span>
                                        </div>
                                    </div>

                                    <div class="col-xs-6 col-sm-3 col-md-2">
                                        <div class="p-20 text-xs-center">
                                            <span data-plugin="peity-donut" data-colors="#f1b53d,#ebeff2"
                                                  data-width="80" data-height="80">226,134</span>
                                        </div>
                                    </div>

                                    <div class="col-xs-6 col-sm-3 col-md-2">
                                        <div class="p-20 text-xs-center">
                                            <span data-plugin="peity-donut" data-colors="#ff5d48,#ebeff2"
                                                  data-width="80" data-height="80">1,2,3,2,2</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-t-50">
                            <div class="col-sm-12 col-xs-12 col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-3 col-md-2">
                                        <div class="p-20 text-xs-center">
                                            <span data-plugin="peity-line" data-fill="#9261c6" data-stroke="#6d3da0"
                                                  data-width="100" data-height="40">5,3,9,6,5,9,7,3,5,2</span>
                                        </div>
                                    </div>

                                    <div class="col-xs-6 col-sm-3 col-md-2">
                                        <div class="p-20 text-xs-center">
                                            <span data-plugin="peity-line" data-fill="#34d3eb" data-stroke="#169c81"
