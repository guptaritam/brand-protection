                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12 col-md-6">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        Stacked chart not only shows the trends over time, you can also see the
                                        cumulative
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-6 col-xs-12 m-t-20">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        The line chart is most often used chart, aslo the easiest to make, it shows
                                        trends over time,
                                        visualizes data and information, so users can know how exactly these numbers are
                                        relate to
                                ...
                                <div class="col-sm-6 col-xs-12 m-t-20">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        Pie chart is used to see the proprotion of each data groups, making Flot pie
