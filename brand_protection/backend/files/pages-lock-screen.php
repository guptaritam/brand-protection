    ...
    <div class="account-bg">
        <div class="card-box m-b-0">
            ...
            <div class="m-t-30 m-b-20">
                <form method="post" action="index.html" role="form" class="text-xs-center m-t-20">
                    <div class="user-thumb">
                        <img src="assets/images/users/avatar-1.jpg" class="img-responsive img-circle img-thumbnail"
                             alt="thumbnail">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-group text-center m-t-20 m-b-0">
                            <div class="col-xs-12">
                                <button class="btn btn-success btn-block waves-effect waves-light" type="submit">Enter
                                    Now
                                </button>
                            </div>
                        </div>
