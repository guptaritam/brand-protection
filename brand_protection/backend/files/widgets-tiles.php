                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-one">
                            ...
                            <span class="label label-warning"> 0% </span> <span
                                class="text-muted">From previous period</span>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-two">
                            ...
                            <progress class="progress progress-striped progress-xs progress-info m-b-0" value="25"
                                      max="100">25%
                            </progress>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-two">
                            ...
                            <progress class="progress progress-striped progress-xs progress-warning m-b-0" value="45"
                                      max="100">45%
                            </progress>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-two">
                            ...
                            <progress class="progress progress-striped progress-xs progress-success m-b-0" value="70"
                                      max="100">70%
                            </progress>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-two">
                            ...
                            <progress class="progress progress-striped progress-xs progress-danger m-b-0" value="95"
                                      max="100">95%
                            </progress>
                        </div>
                    </div>
