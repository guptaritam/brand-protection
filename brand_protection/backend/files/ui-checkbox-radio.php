                        ...
                        <div class="card-box">
                            <div class="row">
                                <div class="col-lg-4 col-xs-12">
                                    ...
                                    <p class="text-muted font-13 m-b-15 m-t-20">Checkboxes without label text <code>.checkbox-single</code>
                                    </p>
                        ...
                        <div class="card-box">
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <p class="text-muted font-13 m-b-15 m-t-20">Radios without label text <code>.radio-single</code>
                                    </p>
